  ...
  override render() {
    ...
    return html`
      ...
      <p class="text-[10px] text-zinc-500 mb-3">
        Choose the stored renderer preference. The experimental renderers may not match every classic feature yet; the Reins scaffold is non-virtual and is not a performance solution.
      </p>
      <select
      ...
      >
        ...
        <option value="virtualized">Reins diff scaffold</option>
      </select>
    `;
  }
