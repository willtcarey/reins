...
- Idle sends are durably accepted before provider execution begins. Busy sends forward directly to the active AgentHarness operation and propagate native steering errors.
