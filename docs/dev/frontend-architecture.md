...
- `review-virtual-layout.ts` — Pure prefix-offset geometry for selecting the bounded review viewport/overscan window, resolving unmounted item offsets, deriving active items, and calculating measurement anchor compensation.
