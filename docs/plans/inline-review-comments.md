...
- [x] Add one optional-task-scoped REST route set over reusable `ProjectCodeReviews`, with optimistic conflicts, idempotent client-identity retry, and post-commit invalidation broadcasts.
